...
class AdvancedChest extends StatefulWidget {
  ...
  @override
  State<AdvancedChest> createState() => _AdvancedChestState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      for (int i = 0;
                      i <
                          advChestWorkoutName.length &
                          advChestWorkoutImage.length &
                          advChestNavigation.length;
                      i++) ...{
                        EntireColumn(
                          name: advChestWorkoutName[i],
                          navigator: advChestNavigation[i],
                          image: advChestWorkoutImage[i],
                          color: redColor,
                        ),
                      }
                    ],
