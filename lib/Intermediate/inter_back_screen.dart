...
class IntermediateBack extends StatefulWidget {
  ...
  @override
  State<IntermediateBack> createState() => _IntermediateBackState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      for (int i = 0;
                      i <
                          interBackWorkoutName.length &
                          interBackWorkoutImage.length &
                          interBackNavigation.length;
                      i++) ...{
                        EntireColumn(
                          name: interBackWorkoutName[i],
                          navigator: interBackNavigation[i],
                          image: interBackWorkoutImage[i],
                          color: blueColor,
                        ),
                      }
                    ],
