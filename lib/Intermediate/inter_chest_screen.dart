...
class IntermediateChest extends StatefulWidget {
  ...
  @override
  State<IntermediateChest> createState() => _IntermediateChestState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      for (int i = 0;
                      i <
                          interChestWorkoutName.length &
                          interChestWorkoutImage.length &
                          interChestNavigation.length;
                      i++) ...{
                        EntireColumn(
                          name: interChestWorkoutName[i],
                          navigator: interChestNavigation[i],
                          image: interChestWorkoutImage[i],
                          color: blueColor,
                        ),
                      }
                    ],
