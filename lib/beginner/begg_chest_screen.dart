...
class BeginnerChest extends StatefulWidget {
  ...
  @override
  State<BeginnerChest> createState() => _BeginnerChestState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      for (int i = 0;
                      i <
                          beginnerChestWorkoutName.length &
                          beginnerChestWorkoutImage.length &
                          beginnerChestNavigation.length;
                      i++) ...{
                        EntireColumn(
                          name: beginnerChestWorkoutName[i],
                          navigator: beginnerChestNavigation[i],
                          image: beginnerChestWorkoutImage[i],
                          color: greenColor,
                        ),
                      }
                    ],
