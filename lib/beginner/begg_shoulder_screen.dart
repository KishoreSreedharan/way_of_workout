...
class BeginnerShoulder extends StatefulWidget {
  ...
  @override
  State<BeginnerShoulder> createState() => _BeginnerShoulderState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      for (int i = 0;
                      i <
                          beginnerShoulderWorkoutName.length &
                          beginnerShoulderWorkoutImage.length &
                          beginnerShoulderNavigation.length;
                      i++) ...{
                        EntireColumn(
                          name: beginnerShoulderWorkoutName[i],
                          navigator: beginnerShoulderNavigation[i],
                          image: beginnerShoulderWorkoutImage[i],
                          color: greenColor,
                        ),
                      }
                    ],
